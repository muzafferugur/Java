...
public interface I02_Interfaces {
    ...
    Eger java'da icinde bir concrete method olmasin dedigimiz bir class olusturmak
    istiyorsaniz bunu class degiil Interface yapmalisiniz.
        ...
        4- Class'larda bir child birden fazla parent edinemez.
        ...
        5- Interface'lar neyin yapilmasini gerektigini soyler ama nasil
            ...
            interface bir çeşit "to do list"tir.neyin yapılması gerektiğini söyler.ne ypılması gerektiği
            değil ne yapılması gerektiği.
     */
}

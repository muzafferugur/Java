...
public class C05_remove {
    public static void main(String[] args) {
        ...
        sayilar1.remove(1);
        /*
        sayılardan olusan bır list varsa
        java remove methodunda sayı yazdığımızda direkt index olarak kabul eder
         */
        ...
        //2 yi silmek için 2nin indexini bulup,onu remove a yazabiliriz
